...
<head>
    <meta name="description"
        content="Jasa transportasi antar jemput karyawan di Karawang dengan armada lengkap dan harga transparan." />
    <meta charset="UTF-8" />
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css"
        integrity="sha512-omJYb+...dll" crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<body class="bg-gray-50 text-gray-800">
        ...
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <nav id="menu"
                ...
                <ul class="flex flex-col md:flex-row md:items-center md:space-x-6">
                    <li>
                        <a href="/" class="block py-3 md:py-0 hover:text-gray-200 transition">
                            {{ __('home.navbar_home') }}
                        </a>
                    </li>
                    <li class="relative group">
                        <a class="flex items-center gap-1 py-3 md:py-0 hover:text-gray-200 transition">
                        ...
                        <ul
                            ...
                            <li>
                                <a href="#kerjasama" class="block px-4 py-2 hover:bg-gray-100 transition">
                    ...
                    <li>
                        <a href="#blogs" class="block py-5 md:py-0 hover:text-gray-200 transition">
                            {{ __('home.navbar_blogs') }}
                        </a>
                    </li>

                    <li>
                        <a href="#hubungi-kami" class="block py-3 md:py-0 hover:text-gray-200 transition">
    ...
    <!-- Footer -->
    <footer id="kontak" class="bg-gray-900 text-gray-300 py-8 mt-16 fade-in">
