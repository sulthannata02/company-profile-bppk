...
@section('content')
    ...
    <section class="relative bg-blue-600 text-white overflow-hidden">
        ...
        <div class="relative w-full" style="aspect-ratio: 16 / 9">
            <div class="absolute inset-0 opacity-20 bg-[url('/public/assets/toyota-hiace.png')] bg-cover bg-center"></div>
    ...
    <section id="visi-misi" class="relative py-20 scroll-mt-20">
        ...
        <div class="relative container mx-auto px-6">
            <h2 class="text-3xl font-bold mb-14 text-blue-600 text-center" data-aos="fade-up">
                {{ __('home.dropdown_vision') }}
            </h2>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto">
                <!-- CARD VISI -->
                <div class="bg-white rounded-2xl shadow-md p-8 hover:shadow-xl transition" data-aos="fade-right">
                ...
                <!-- CARD MISI -->
                <div class="bg-white rounded-2xl shadow-md p-8 hover:shadow-xl transition" data-aos="fade-left">
                    <div class="flex items-center justify-center mb-5">
                        <div class="w-16 h-16 flex items-center justify-center rounded-full bg-blue-100">
    ...
    <!-- Mengapa Kami -->
    <section id="mengapa-kami" class="bg-gradient-to-b from-gray-100 to-white py-20 scroll-mt-20">
        <div class="container mx-auto px-6">
            <!-- Title -->
            <div class="text-center mb-14">
                <h2 class="text-3xl md:text-4xl font-bold text-blue-700 mb-4" data-aos="fade-up">
                    {{ __('home.why_us') }}
                </h2>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide flex">
                        <div class="bg-white rounded-2xl shadow-lg p-8 w-full">
                            <div class="w-16 h-16 mb-6 flex items-center justify-center rounded-full bg-blue-100">
                    ...
                    <div class="swiper-slide flex">
                        <div class="bg-white rounded-2xl shadow-lg p-8 w-full">
                            <div class="w-16 h-16 mb-6 flex items-center justify-center rounded-full bg-green-100">
                                <i class="fa-solid fa-file-contract text-green-600 text-2xl"></i>
                            </div>
                            <h3 class="text-xl font-semibold text-blue-700 mb-2">
                                {{ __('home.why_2_title') }}
                            </h3>
                    ...
                    <div class="swiper-slide flex">
                        <div class="bg-white rounded-2xl shadow-lg p-8 w-full">
                            <div class="w-16 h-16 mb-6 flex items-center justify-center rounded-full bg-yellow-100">
                    ...
                    <div class="swiper-slide flex">
                        <div class="bg-white rounded-2xl shadow-lg p-8 w-full">
                            <div class="w-16 h-16 mb-6 flex items-center justify-center rounded-full bg-purple-100">
    ...
    <section id="kerjasama" class="scroll-mt-20 py-20 bg-gray-100 fade-in">
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-blue-600" data-aos="fade-up">
                    {{ __('home.partnership') }}
                </h2>
    ...
    <section id="daftar-mobil" class="bg-gray-100 py-20">
        <div class="container mx-auto px-10">
            <h2 class="text-3xl font-bold text-center mb-12 text-blue-700" data-aos="fade-up">
                {{ __('home.vehicles') }}
            </h2>
                    ...
                    @foreach ($mobils as $mobil)
                        <div class="swiper-slide">
                            <div
                                ...
                                <!-- Image -->
                                <div class="relative">
                                    <img src="{{ asset('mobil/' . $mobil->gambar) }}" alt="{{ $mobil->nama_mobil }}"
                                ...
                                <div class="p-6" data-aos="fade-up" data-aos-delay="100">
                                    ...
                                    <p class="text-gray-600 mb-4 flex items-center gap-2">
                                        <i class="fa-solid fa-chair text-blue-600"></i>
                                        {{ __('home.capacity') }}:
    ...
    <!-- Blog Section -->
    <section id="blogs" class="bg-gray-100 py-20 scroll-mt-20">
            ...
            <div class="grid md:grid-cols-3 gap-8" data-aos="fade-up">
                ...
                @forelse ($blogs as $blog)
                    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
                        ...
                        <!-- Thumbnail -->
                        <img src="{{ asset('blog/' . $blog->thumbnail) }}" alt="{{ $blog->title }}"
                ...
                <div class="flex flex-col justify-center ml-10" data-aos="fade-right" data-aos-delay="200">
                    ...
                    <div class="flex items-start gap-3 mb-5">
                        ...
                        <div>
                            ...
                            <a href="https://wa.me/6281998062726?text=Halo%20saya%20ingin%20bertanya%20tentang%20layanan%20PT%20Berkah%20Putra%20Putri%20Karawang!"
                                target="_blank" class="font-semibold link-underline hover:text-blue-600 transition">
                                +62 819 9806 2726
                            </a>
                            <br />
                            <a href="https://wa.me/6285319447224?text=Halo%20saya%20ingin%20bertanya%20tentang%20layanan%20PT%20Berkah%20Putra%20Putri%20Karawang!"
                                target="_blank" class="font-semibold link-underline hover:text-blue-600 transition">
                                +62 853 1944 7224
                            </a>
                            <br />
                            <a href="https://wa.me/6283890576716?text=Halo%20saya%20ingin%20bertanya%20tentang%20layanan%20PT%20Berkah%20Putra%20Putri%20Karawang!"
                                target="_blank" class="font-semibold link-underline hover:text-blue-600 transition">
                                +62 838 9057 6716
                            </a>
                        </div>
